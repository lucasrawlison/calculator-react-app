...
export const ButtonsContainer = ({handleInsertDot, handleNegative, handleEraseInput, handleDel, handleNumberImput, handleOperatorInput, handleOperationResult, result, setResult, setCurrentValue, setOperator, setPreviousNumber, currentValue, operator, previousNumber}) =>{

    return(
    <div className="buttons-container">
      <button onClick={()=> handleEraseInput(setCurrentValue, setPreviousNumber, setOperator)} className="action-button">AC</button>
      <button  onClick = {() => handleNegative(currentValue, setCurrentValue)} className="action-button">+/-</button>
      <button onClick={()=> handleOperatorInput('%', previousNumber, currentValue, setPreviousNumber, setCurrentValue, setOperator)} className="action-button">%</button>
      <button onClick={()=> handleOperatorInput('/', previousNumber, currentValue, setPreviousNumber, setCurrentValue, setOperator)} className="action-button">/</button>
      ...
      <button onClick={()=> handleOperatorInput('*', previousNumber, currentValue, setPreviousNumber, setCurrentValue, setOperator )} className="action-button">X</button>
      ...
      <button onClick={() => handleInsertDot(currentValue, setCurrentValue, setResult)} className="action-button">.</button>
